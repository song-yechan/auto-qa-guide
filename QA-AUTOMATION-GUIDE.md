...
└─────────────────────────────────────┘
                 ↓
Phase 3.5: 앱 접근 확인 (앱 설정한 경우만)
┌─────────────────────────────────────┐
│ 8. 앱 접근 테스트 실행 (브라우저 오픈)  │
│ 9. 결과 처리:                        │
│    - 앱 없음 → 알림 후 이름 재입력     │
│    - 앱 있음 → 화면 띄우고 확인 요청   │
│      ✓ "네" → 창 닫으면 테스트 시작   │
...
Phase 4: 실행
┌─────────────────────────────────────┐
│ 10. 페이지 구조 파악 (codegen, 필요시) │
│ 11. 테스트 코드 작성 (.spec.ts)       │
│ 12. Playwright 테스트 실행            │
└─────────────────────────────────────┘
                 ↓
Phase 5: 산출물 저장
┌─────────────────────────────────────┐
│ 13. report/, results/ 폴더 정리       │
│ 14. 결과 리포트 작성 (.md)            │
└─────────────────────────────────────┘
                 ↓
Phase 6: 검증
┌─────────────────────────────────────┐
│ 15. 테스트 리포트 브라우저에서 오픈     │
│ 16. 객관식 선택지 제시                │
│     - 테스트 완료 → 종료              │
│     - UI 모드로 추가 확인 → 실행       │
└─────────────────────────────────────┘
